...
spice_file = "~/work/spice_psf/spice_data/solo_L2_spice-n-ras_20221024T191303_V22_150995395-059.fits"
...
shift_vars = shift_holder(spice_dat, spice_hdr, fitter.__name__, save_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20221024/',
                          linelist=linelist)

sv_initial = search_shifts(spice_dat, spice_hdr, xs_initial, ys_initial,
                           lsq_fitter, search_multi_thread=True, search_nthread=36,
                           yrange_plot_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20221024/yrange_plots/',
...
x_refine, y_refine = refine_points(shift_vars,[-5,5],[-5,5], 91, 91, 20)
shift_vars = search_shifts(spice_dat, spice_hdr, x_refine, y_refine,
                           lsq_fitter, shift_vars=shift_vars, search_multi_thread=True, search_nthread=36,
                           yrange_plot_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20221024/yrange_plots/',
                           linelist=linelist)
...
plt.savefig(os.path.join('/cluster/home/zhuyin/work/spice_psf/spice_skew_20221024/yrange_plots/','varplot_'+labelstr+'.png'))
plt.close()
