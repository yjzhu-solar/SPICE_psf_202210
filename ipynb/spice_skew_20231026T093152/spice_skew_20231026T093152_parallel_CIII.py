...
spice_file = "~/work/spice_psf/spice_data/solo_L2_spice-n-ras_20231026T093152_V22_218104177-004.fits"

with fits.open(spice_file) as hdul:
    hdul.info()
    spice_hdr = hdul[6].header.copy()
    spice_dat = hdul[6].data[0].copy()
...
shift_vars = shift_holder(spice_dat, spice_hdr, fitter.__name__, save_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20231026/',
                          linelist=linelist)
...
plt.savefig(os.path.join('/cluster/home/zhuyin/work/spice_psf/spice_skew_20231026/yrange_plots/','varplot_'+labelstr+'.png'))
plt.close()
