...
spice_file = "~/work/spice_psf/spice_data/solo_L2_spice-n-ras_20220306T183131_V22_100663715-000.fits"
...
plt.savefig(os.path.join('/cluster/home/zhuyin/work/spice_psf/spice_skew_20220306/yrange_plots/','varplot_'+labelstr+'.png'))
plt.close()
