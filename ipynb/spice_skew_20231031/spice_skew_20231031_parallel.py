...
shift_vars = shift_holder(spice_dat, spice_hdr, fitter.__name__, save_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20231031/')

sv_initial = search_shifts(spice_dat, spice_hdr, xs_initial, ys_initial,
                           lsq_fitter, search_multi_thread=True, search_nthread=32,
                           yrange_plot_dir='/cluster/home/zhuyin/work/spice_psf/spice_skew_20231031/yrange_plots/',
...
plt.savefig(os.path.join('/cluster/home/zhuyin/work/spice_psf/spice_skew_20231031/yrange_plots/','varplot_'+labelstr+'.png'))
plt.close()
